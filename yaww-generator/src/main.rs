...
fn main() -> Result<()> {
    ...
    swwriteln!(state, "use core::{{fmt, mem, ptr, slice, num::NonZeroIsize, marker::PhantomData}};")?;
    ...
    swwriteln!(state, "use std::{{ffi::{{OsStr, OsString}}, os::windows::prelude::*}};")?;
    swwriteln!(state, "#[doc(inline)]")?;
    swwriteln!(state, "use windows_sys::core::*;")?;
    swwriteln!(state, "use windows_sys::Win32::Foundation::{{LPARAM, WPARAM, LRESULT}};")?;
